...
<div class="container-fluid mt-3 content">
  ...
  <h3 class="h3 mt-4">Your Team Ratings</h3>
  <div class="row mt-4">
    <div class="col-md-6 mb-4">
      <div class="card bg-primary text-white">
        <div class="card-body">
  ...
  <h3 class="h3 mt-4">Personnel Dashboard</h3>
    ...
    <tbody>
      ...
      foreach ($personnel_data as $personnel) {
        ...
        <tr>
          ...
          <td>
            <a class="btn btn-secondary btn-sm" href="<?php echo base_url('admin/mgt/survey') . "/" . $personnel['personnel_ratee_id']; ?>">
              View
            </a>
          </td>
        </tr>
