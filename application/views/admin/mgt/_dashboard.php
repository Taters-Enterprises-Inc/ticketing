    ...
    <div class="container-fluid">
        <div class="row flex-nowrap">
                ...
                <div class="d-flex flex-column align-items-center align-items-sm-start px-3 pt-2 text-white min-vh-100">
                    ...
                    <div class="dropdown pb-4 dropdown-to-bottom">
                        ...
                        <ul class="dropdown-menu dropdown-menu-dark text-small shadow" aria-labelledby="dropdownUser1">
                            <li><a class="dropdown-item" href="<?php echo base_url('admin/mgt/profile/edit/') .$ratee_id; ?>">Edit Profile</a></li>
                            <li>
            ...
            <div class="col py-3">
                ...
                <div class="card mt-5">
                    <div class="card-body">
                        <h3 class="card-title mb-4">Ratings</h5>
                        <div class="row mt-4">
                ...
                <div class="card mt-5">
                    <div class="card-body">
                        <h3 class="card-title mb-4">Your Team Ratings</h5>
                        <div class="row mt-4">
                            <div class="col-md-6 mb-4">
                                <div class="card bg-secondary text-white">
                                    <div class="card-body">
                ...
                <div class="card mt-5">
                    <div class="card-body">
                        <h3 class="card-title mb-4">Personnel Dashboard</h5>
