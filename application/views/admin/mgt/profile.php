            ...
            <div class="card-body pt-3">
              ...
              <div class="tab-content pt-2">
                ...
                <div class="tab-pane fade profile-edit pt-3" id="profile-edit">
                  ...
                  <!-- Profile Edit Form -->
                  <form method="post" action="<?php echo base_url('admin/mgt/profile/update') . "/" . $user_id; ?>">
                    <div class="row mb-3">
                    ...
                    <div class="row mb-3">
                      <label for="password" class="col-md-4 col-lg-3 col-form-label">Password (New)</label>
                      <div class="col-md-8 col-lg-9">
