...
<body>
      ...
      <ul class="d-flex align-items-center">
        ...
        <li class="nav-item dropdown pe-3">
          ...
          <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow profile">
            ...
            <li>
              <a class="dropdown-item d-flex align-items-center" href="<?php echo base_url('admin/user/profile/edit/') .$ratee_id; ?>">
  ...
  <aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link" href="<?php echo base_url('admin/user/dashboard/') .$ratee_id; ?>" style="background-color: #212529">
          <i class="bi bi-grid" style="color: #fff"></i>
          <span style="color: #fff">Dashboard</span>
        </a>
      </li><!-- End Dashboard Nav -->
      <li class="nav-item">
        <a class="nav-link" href="<?php echo base_url('admin/user/profile/edit/') .$ratee_id; ?>" style="background-color: #212529">
