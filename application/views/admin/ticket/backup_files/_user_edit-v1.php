    ...
    <div class="container-fluid">
        <div class="row flex-nowrap">
            ...
            <div class="col py-3">
                ...
                <div class="card mt-5">
                    <div class="card-body">
                        <h3 class="card-title mb-4">Edit User</h5>
                        <form method="post" action="<?php echo base_url('admin/sa/updateuser') . "/" . $user_id; ?>">
                            <div class="mt-4">
                                <label class="form-label">First name</label>
                                <input type="text" class="form-control" id="first_name" placeholder="Input New First Name" name="first_name" value="<?php echo $first_name; ?>" required>
                            </div>
                            <div class="mt-4">
                                <label class="form-label">Last name</label>
                                <input type="text" class="form-control" id="last_name" placeholder="Input New Last Name" name="last_name" value="<?php echo $last_name; ?>" required>
                            </div>
                            <div class="mt-4">
